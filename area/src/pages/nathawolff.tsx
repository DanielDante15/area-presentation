        ...
        <div className="py-4 px-10 rounded-lg">
          <div className="grid grid-cols-8 mb-8 gap-10">
            <div className="flex items-center justify-start">
              <Image
                ...
                alt="img"
                src="/Natha.png"
                className="max-h-full p-1 bg-green-600 rounded-full"
              />
            </div>
            <div className="col-span-7 flex flex-col justify-center items-start h-36">
              ...
              <div className="flex gap-3 mt-6">
                <a href="https://github.com/NWolff9" target="_blank">
                  <Image
                    width={100}
                    height={100}
          ...
          <div className="h-48 py-4">
            ...
            <ul className="space-y-1 text-gray-500 list-disc list-inside">
              <li>
                Technical Mechatronics | Senai Roberto Mange
                | 2020 - 2021
              </li>
              <li>
              ...
              <li> Software Engineering | UniMetrocamp | 2023 - 2027</li>
            </ul>
          </div>
          ...
          <div className="">
            ...
            <ul className="space-y-1 text-gray-500 list-disc list-inside">
              ...
              <li>
                <strong>America Managament Projects</strong> - Power BI from GS/OBR15-LA1
              </li>
              <li>
                <strong>Borum (Einer)</strong> - TCC project currently in development
              </li>
            </ul>
          </div>
        </div>
